...
| **Partial Selects** | Native (Rust-enforced)   | Supported                 | Supported              | Supported                           |
| **Composite Keys**  | Supported (Identity Map) | Supported                 | Limited                | Supported                           |
...
- **Composite Key Support**: Fully integrated with the Task-scoped Identity Map.
- **Partial Model Enforcement**: Prevents accidental data leakages and overfetching.
- **FastAPI Integration**: Out-of-the-box router generation for RESTful services.
- **Admin Tooling**: Built-in panel for secure schema inspection and data management.
- **Advanced Relation Fetchers**: Optimized Rust-side JOINs for M:N and self-ref relations.
